...
namespace WebCurs2.Views.Shared.Components.FooterPartViewComponent
{
    public class FooterPartViewComponent : ViewComponent
    {
        private ApplicationDbContext _context;
        private IOptionRepository _optRep { get; set; }
        
        public FooterPartViewComponent(IServiceProvider services)
        {
