...
namespace WebCurs2.Views.Shared.Components.OffCanvas
{
    public class OffCanvasViewComponent : ViewComponent
    {
        private ApplicationDbContext _context;
        private IOptionRepository _optRep { get; set; }
        
        public OffCanvasViewComponent(IServiceProvider services)
        {
